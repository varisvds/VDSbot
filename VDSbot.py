...
cl.login(token="EmIz82dCyXpOJnGmvfre.BNw/5EN2WkbkEcLxkKYidG.pAUzgzyNaGjMi5R2CosS64y1fwKfycwq+vpDd/vQChM=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="Em6Wd2qn1jsH8AaYXV24.KQEuO0SoX+GQNa14hsjUza.tuEQTePqi5mAEkfnO7UeOOZO+TAxH2vRG1ydlSuXDSU=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EmJSJIG6oVGTUE7QiXM9.H75/V8Q6IV/sEyi3Pt9Icq.yRI0ShEGuSOiCzBgOlq5m5zJbagiF17xnjH4OJZiK6s=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EmAFwIRHKLiTd2gmbcn6.xsF8LnFGI0nsNNLzyp7jXG.vAKjnsDiOedO7P64SCfEcMCjJpraRo8LqYn90XnN/sM=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EmeKByLncEHNAEeYaKvd.H7/Bb5MXqRJbyeeDSzwG7q.mNsoIFz7a7dkjoJ7GW/EsmnBEGS8x0juTfmicKSWb3A=")
ks.loginResult()

print "VDS BOT login success gan"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""       ✰【ⱽƊs T℮əʍ  β๏₮】✰
     -==================-
◄]·🔰·Commant Member·🔰·[►
[⊙]Adminlist
[⊙]Ownerlist
...
[⊛]Admin-/admin+
-======================-
 [V̳̿D̳̿S̳̿][T̳̿E̳̿A̳̿M̳̿][B̳̿O̳̿T̳̿][M̳̿A̳̿K̳̿E̳̿R̳̿]
-=======================-
"""
KAC=[cl,ki,kk,kc,ks]
...
admin=["u95f09988227a211a1261c61b47836691","u5111c61b782841919c5c9975a05dc1fc"] 
owner=["u95f09988227a211a1261c61b47836691","u5111c61b782841919c5c9975a05dc1fc"]
wait = {
    'contact':False,
    'autoJoin':True,
...
Minat gab? Silahkan PM!
Idline: http://line.me/ti/p/~varisdarkscream""",
    "lang":"JP",
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              ...
              if op.param2 in admin:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Woey Jangan Mainan QR Njiiir")
...
#--------------------------------
    ...
    #--------------- SC Add Admin ---------
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"perintah nikung selesai")
                        except:
                            pass
                print "[Command]Staff add executed"
              else:
                cl.sendText(msg.to,"emoh nurut")
                cl.sendText(msg.to,"lu bukan boss gua")
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"done remove admin ini soalnya gak bisa desah")
                        except:
                            pass
              ...
              if admin == []:
                  ...
                  cl.sendText(msg.to,"Ough...")
                  mc = "||😍Njirr!!! Adminnya keren ouy😍||\n=====================\n"
                  for mi_d in admin:
    ...
    #-------------- Add Friends ------------
              ...
              if msg.toType == 2:
                ...
                cl.sendText(msg.to,"emoh.")                
                cl.sendText(msg.to,"gua bukan babu lu...")
              ...
              if msg.from_ in admin:
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 300:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["All bot"]: #Ngirim Semua Kontak Bot
              if msg.from_ in admin:
                msg.contentType = 13
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Terbuka gan")
                else:
                    if wait["lang"] == "JP":
                ...
                cl.sendText(msg.to,"emoh manut")
                cl.sendText(msg.to,"wekkkkkkk")
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup gan")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
		...
		for ticket_id in n_links:
            ...
            elif msg.text in ["Wkwkwk","Wkwk","Wk","wkwkwk","wkwk","ngakak","Ngakak"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
              ...
              if msg.from_ in owner:
                ...
                if gid == "":
                  ...
                  try:
                    ...
                    cl.sendText(msg.to,"gak ada aku di room itu boss")
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "menghitung CCTV dimulai")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "|| 【ⱽƊs T℮əʍ  β๏₮】 ||\n||Di Read Oleh||\n===============%s\n>Tukang Ngintip<\n===============\n%s-=CCTV=-\n====================\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Set Sider\nBaru Ketil Ciduk\nGak bisa mainin Bot ya!!\nVacum ajh sono")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Dark","Comeon"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Muleh all","Pulang all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Muleh","Pulang"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["desah","Desah","Hello","Tag all"]:
            	 if msg.from_ in admin:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"OTW Like Status Owner\nJangan diganggu\nlagi fokus")
                try:
                  likePost()
                except:
                  pass
                
            elif msg.text in ["Like temen", "like temen"]: #Semua Bot Ngelike Status Teman
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"otw Like Status Teman Boss")
                cl.sendText(msg.to,"OTW Like Status Owner\nJangan diganggu\nlagi fokus")
                try:
                  autolike()
                except:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        random.choice(KAC).sendText(msg.to,"Jangan masuk lagi􀨁􀆷 anjink")
                        return
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        cl.sendText(msg.to,"Dont Banned Bot")
                        ki.sendText(msg.to,"Dont Banned Bot")
                        kk.sendText(msg.to,"Dont Banned Bot")
                        kc.sendText(msg.to,"Dont Banned Bot")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
        ...
        #-------------Fungsi Spam Start---------------------#
            elif msg.text in ["Crot","Crott","Up chat"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"Crotttt!!!")
                ki.sendText(msg.to,"Crotttt!!!")
                kk.sendText(msg.to,"Crotttt!!!")
                cl.sendText(msg.to,"Crotttt!!!")
                ki.sendText(msg.to,"Crotttt!!!")
                kk.sendText(msg.to,"Crotttt!!!")
                cl.sendText(msg.to,"Crotttt!!!")
      ...
      #--------------Fungsi Broadcast Finish-----------#
            ...
            elif msg.text in ["Listgroub"]: #Melihat List Group
              if msg.from_ in admin:
            ...
            elif msg.text in ["ListgroubID"]: #Melihat List Group + ID Groupnya (Gunanya Untuk Perintah InviteMeTo:)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
                h = ""
                for i in gid:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bubar","Minggat"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
            elif msg.text in ["Cv say afi pekok"]:
                ki.sendText(msg.to,"afi pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"afi pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"afi pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say koko pekok"]:
                ki.sendText(msg.to,"koko pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"koko pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"koko pekok 􀜁􀅔Har Har􏿿")
                ...
                kk.sendText(msg.to,"Jangan engas ok!")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen anak2","Absen dulu","On"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"kang desah On")
                ki.sendText(msg.to,"kang colli On")
                kk.sendText(msg.to,"kang engas On")
                kc.sendText(msg.to,"kang nyabun On")
                ks.sendText(msg.to,"kang colmek on")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap sangein member Group\nOugh..ough!!😂")
      #-------------Fungsi Respon Finish---------------------#
                            

      #-------------Fungsi Balesan Respon Start---------------------#
            elif msg.text in ["bot","ris","Ris","Varis","varis","min","Min","om","Om"]:
                ki.sendText(msg.to,"apa kangen yah? pasti mau minta jatah kelon ye!!")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Sabar Gan\n███▓Loading...!!")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sdtk" % (elapsed_time))
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u95f09988227a211a1261c61b47836691'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator kami yg ough😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["sayang","Bot"]:
                 quote = ['apa syg','apa panggil2']
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        random.choice(KAC).kickoutFromGroup(msg.to,[jj])
                        random.choice(KAC).kickoutFromGroup(msg.to,[jj])
                    random.choice(KAC).sendText(msg.to,"Blacklist sudah di usir")
                    random.choice(KAC).sendText(msg.to,"Blacklist sudah di usir")
                    random.choice(KAC).sendText(msg.to,"Blacklist sudah di usir")
                    random.choice(KAC).sendText(msg.to,"Blacklist sudah di usir")
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Ucap Salam ke Founder Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "wkkk korban baper left")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == true:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】")
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】MY JURAGANT⌦http://line.me/ti/p/~Varisdarkscream")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == true:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AUTO LIKE BY【ⱽƊs T℮əʍ  β๏₮】")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"MY JURAGANT⌦http://line.me/ti/p/~Varisdarkscream")
                    print "Like"
                except:
                    pass
            else:
                print "Status Sudah di Like Gan"
